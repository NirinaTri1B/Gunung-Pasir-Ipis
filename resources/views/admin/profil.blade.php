                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_user" class="form-control" value="{{ Auth::user()->nama_user }}" required style="border-radius: 8px;">
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="font-weight-bold" style="color: #4a5568;">Alamat Email</label>
                                <input type="email" name="email" class="form-control text-muted" value="{{ Auth::user()->email }}" disabled style="border-radius: 8px; background-color: #f8f9fa;" title="Email utama tidak dapat diubah">
                            </div>
                        </div>
                    </div>

                    <div class="form-group mb-3">
                        <label class="font-weight-bold" style="color: #4a5568;">
                            Kata Sandi Sekarang <span class="text-danger">*</span>
                        </label>
                        ...
                        <div style="position: relative;">
                            <input
                                ...
                                required
                                style="border-radius: 8px; padding-right: 45px;"
                            >

                            <i class="fas fa-eye-slash togglePassword"
                            data-target="passwordSekarang"
                            style="
                                    position: absolute;
                                    right: 15px;
                                    top: 50%;
