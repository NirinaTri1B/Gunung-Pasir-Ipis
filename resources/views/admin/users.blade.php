                ...
                <div class="modal-body bg-light">
                    ...
                    <div class="form-group">
                        ...
                        <div style="position: relative;">
                            <input type="password" name="password" class="form-control" placeholder="Minimal 6 karakter..." required style="border-radius: 8px; padding-right: 45px;">
                            <i class="fas fa-eye-slash toggle-password-btn" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #6c757d;"></i>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <form id="formEditAkun" method="POST">
                ...
                <div class="modal-body bg-light">
                    ...
                    <div class="form-group">
                        ...
                        <div style="position: relative;">
                            <input type="password" name="password" class="form-control" placeholder="Masukkan password baru jika mau ganti..." style="border-radius: 8px; padding-right: 45px;">
                            <i class="fas fa-eye-slash toggle-password-btn" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #6c757d;"></i>
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    // JAVASCRIPT GLOBAL UNTUK MATA PASSWORD (BISA BERJALAN DI SEMUA FORM)
    $(document).on('click', '.toggle-password-btn', function() {
        // Mencari input password yang berada satu baris kotak dengan tombol mata yang di-klik
