  ...
  <div class="container">
    ...
    <div class="splash-buttons">
        <a href="#about" class="btn-splash btn-explore">
             Yuk, Jelajahi Selengkapnya! <i class="fas fa-arrow-right"></i>
        </a>
    </div>
  </div>
</div>
            ...
            <div style="flex: 1; min-width: 250px;">
                ...
                <ul style="list-style: none; padding: 0; margin: 0;">
                    <li style="margin-bottom: 10px;">
                        ...
                        <strong>Jam Buka:</strong> {{ $konten['jam_buka']->value }}
                    </li>
                    <li>
                        <i class="fa fa-calendar-times" style="color: #728156; width: 20px;"></i>
                        <strong>Tutup:</strong> {{ $konten['hari_tutup']->value }}
                    </li>
                </ul>
            </div>
            ...
            <div style="flex: 1; min-width: 250px;">
                ...
                <ul style="list-style: none; padding: 0; margin: 0;">
                    <li style="margin-bottom: 10px;">
                        ...
                        <strong>Tektok:</strong> Rp {{ number_format($konten['harga_tektok']->value, 0, ',', '.') }} / orang
                    </li>
                    <li>
                        <i class="fa fa-campground" style="color: #728156; width: 20px;"></i>
                        <strong>Camping:</strong> Rp {{ number_format($konten['harga_camping']->value, 0, ',', '.') }} / orang
                    </li>
                </ul>
            </div>
        </div>
  ...
  <div class="container cf text-center">
    ...
    <div class="row" style="display: flex; justify-content: space-around; flex-wrap: wrap;">
      <div class="col-3" style="flex: 1; min-width: 250px; padding: 20px;">
        ...
        <h3 style="color: #414833; margin-top: 15px;">Jalur Tracking</h3>
        <p style="color: #666;">Kamu dapat melihat jalur pendakian secara real-time.</p>
      </div>
      <div class="col-3" style="flex: 1; min-width: 250px; padding: 20px;">
      ...
      <div class="col-3" style="flex: 1; min-width: 250px; padding: 20px;">
        ...
        <p style="color: #666;">Dapatkan peringatan situasi rute sebelum naik dan bantuan rescue cepat jika kamu terjebak kondisi bahaya di lapangan.</p>
        </div>
    </div>

    <div class="mt-5 p-5" style="background: #414833; color: white; border-radius: 15px; margin-top: 60px; padding: 40px;">
        <h3 style="color: white; margin-bottom: 15px;">Siap Menjelajahi Gunung Puncak Pasir Ipis?</h3>
...
<div class="container-fluid portfolio" id="portfolio">
  <div class="container cf">
    ...
    <div class="gallery" style="display: flex; overflow-x: auto; gap: 15px; padding-bottom: 15px; scroll-snap-type: x mandatory; -webkit-overflow-scrolling: touch;">

      @forelse($galeri as $g)
        <div class="gallery-image" style="flex: 0 0 calc(33.333% - 10px); min-width: 280px; scroll-snap-align: start;">
            <img src="{{ asset('storage/galeri/' . $g->foto) }}" alt="{{ $g->judul }}" style="width: 100%; border-radius: 8px; object-fit: cover; height: 220px;">
        </div>
      @empty
...
<div class="container-fluid contact" id="contact">
    <div class="container cf">
        ...
        <div class="contact-card" style="margin-top: 10px;">
            ...
            <h2 style="margin-bottom: 10px; font-size: 1.6em;">HUBUNGI KAMI</h2>
           ...
           <div class="col-3" style="flex: 1; min-width: 280px;">
                <i class="fa fa-phone" style="font-size: 2em; color: #414833; margin-bottom: 15px;"></i>
                <h3>Kontak</h3>

                <div style="text-align: left; display: inline-block; white-space: nowrap; line-height: 2;">

                    <div style="display: flex; align-items: center; gap: 10px;">
                        <i class="fas fa-envelope" style="color: #414833; width: 20px; text-align: center;"></i>
                        <a href="mailto:info@gmail.com" style="color: inherit; text-decoration: none;">info@gmail.com</a>
                    </div>

                    <div style="display: flex; align-items: center; gap: 10px;">
                        <i class="fas fa-phone-alt" style="color: #414833; width: 20px; text-align: center;"></i>
                        <a href="tel:0123456789" style="color: inherit; text-decoration: none;">(0123) 456789</a>
                    </div>

                    <div style="display: flex; align-items: center; gap: 10px;">
                        <i class="fab fa-whatsapp" style="color: #414833; width: 20px; text-align: center; font-size: 1.1em;"></i>
                        <a href="https://wa.me/6283148112886" target="_blank" style="color: inherit; text-decoration: none;">+62 831-4811-2886</a>
                    </div>
            ...
            <div class="col-3">
                ...
                <h3>Media Sosial</h3>
                <!-- Kontainer icon agar berjejer ke samping dengan rapi -->
                <div style="display: flex; justify-content: center; gap: 20px; margin-top: 15px;">
                    <!-- Icon Instagram -->
                    <a href="https://www.instagram.com/puncakpasiripis_" target="_blank" title="Instagram @puncakpasiripis_" style="color: #414833; transition: 0.3s; text-decoration: none;">
                        <i class="fab fa-instagram" style="font-size: 1.5em;"></i>
                    </a>

                    <!-- Icon TikTok -->
                    <a href="https://www.tiktok.com/@puncakpasiripis1307mdpl" target="_blank" title="TikTok @puncakpasiripis1307" style="color: #414833; transition: 0.3s; text-decoration: none;">
