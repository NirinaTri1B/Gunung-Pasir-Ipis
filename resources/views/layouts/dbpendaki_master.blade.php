...
<head>
    ...
    .leaflet-marker-icon[src*="marker-icon.png"] {
        ...
        /* Geser kaki pin biar pas di koordinat */
    ...
    .leaflet-marker-shadow {
        ...
        display: none; /* Atau hapus baris ini kalau mau ada bayangan */
    }
        /* CSS RESET & UTILITY */
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .header {
            ...
            /* TAMBAHKAN INI */
            position: fixed;   /* Biar diem di tempat */
            top: 0;
            right: 0;
            width: calc(100% - 260px); /* 260px adalah lebar sidebar Elsa */
            z-index: 1000;     /* Biar di depan konten lain */
            height: 60px;      /* Kita kunci tingginya */
        }
        /* HEADER STYLE */
        .header-user {
            display: flex;
            ...
            gap: 10px;
            font-size: 14px;
            color: #FFFFFF !important; /* Kita ganti jadi putih bersih */
            font-weight: 500; /* Biar agak tegas sedikit */
        }

        .header-user span {
            color: #FFFFFF !important; /* Pastikan teks di dalam span juga putih */
        }

        .header-user i {
            font-size: 20px;
            color: #F4F7F0; /* Ikon biarin putih tulang sedikit hijau biar estetik */
        }
        ...
        .main-content {
            ...
            /* TAMBAHKAN INI */
            padding-top: 60px; /* Harus sama dengan tinggi header di atas */
        }
        ...
        .swal2-title {
            color: #A94442 !important; /* Warna merah darurat */
