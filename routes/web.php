...
// Tahap 1: Minta Email Lupa Password
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/sos/update-lokasi-pendaki', [App\Http\Controllers\PendakiController::class, 'updateLokasiPendaki'])->name('sos.update-lokasi-pendaki');
    ...
    Route::put('/admin/ulasan/toggle/{id}', [AdminController::class, 'toggleUlasan'])->name('admin.ulasan.toggle');
    Route::post('/admin/ulasan/reply/{id}', [AdminController::class, 'replyUlasan'])->name('admin.ulasan.reply');
    Route::put('/admin/ulasan/update/{id}', [AdminController::class, 'updateUlasan'])->name('admin.ulasan.update');
    Route::delete('/admin/ulasan/delete/{id}', [AdminController::class, 'deleteUlasan'])->name('admin.ulasan.delete');

    // 1. Route Kelola Galeri
    Route::get('/admin/galeri', [GaleriController::class, 'index'])->name('admin.galeri');
    Route::post('/admin/galeri/restore/{id}', [GaleriController::class, 'restore'])->name('admin.galeri.restore');
    Route::post('/admin/galeri/store', [GaleriController::class, 'store'])->name('admin.galeri.store');
    Route::post('/admin/galeri/restore-all', [GaleriController::class, 'restoreAll'])->name('admin.galeri.restore_all');
    Route::delete('/admin/galeri/force-delete-all', [GaleriController::class, 'forceDeleteAll'])->name('admin.galeri.force_delete_all');
    Route::delete('/admin/galeri/destroy/{id}', [GaleriController::class, 'destroy'])->name('admin.galeri.destroy');
    Route::delete('/admin/galeri/force-delete/{id}', [GaleriController::class, 'forceDelete'])->name('admin.galeri.force_delete');

    // Kelola Konten
    Route::get('/admin/konten', [AdminController::class, 'konten'])->name('admin.konten');
    Route::post('/admin/konten/update', [AdminController::class, 'updateKonten'])->name('admin.konten.update');
