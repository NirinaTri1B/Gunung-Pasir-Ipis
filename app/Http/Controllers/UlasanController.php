...
class UlasanController extends Controller
{
    ...
    {
        // Ambil semua ulasan beserta data user yang berkomentar
        $ulasan = \App\Models\Ulasan::with('user')->latest()->get();

        // Cek apakah user ini sedang dalam status pendakian aktif
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Ulasan berhasil diunggah!');
    }
